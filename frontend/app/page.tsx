        ...
        <Reveal className="site relative py-24 md:py-28">
          ...
          <div className="mt-14 grid gap-8 md:grid-cols-3">
            {[["On relève.", "Les cotes 1N2 de Betclic, Winamax, Unibet, PMU, NetBet et Pinnacle, plusieurs fois par jour. Chaque relevé est conservé."],
              ...
              <div key={t} className="hair-dark pt-7"><b className="block font-tight text-[24px] font-bold tracking-[-0.03em]">{t}</b><p className="mt-2.5 text-[16px] leading-relaxed text-faint-text">{p}</p></div>
            ))}
          </div>
        </Reveal>
      </section>
